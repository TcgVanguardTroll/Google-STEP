...
public final class FindMeetingQueryTest {
    ...
    private static final int TIME_ALL = TimeRange.WHOLE_DAY;
    ...
    @Test
    public void considerPeopleWIthFullDayEvents() {
        // Have each person have different events. We should see two options because each person has
        // split the restricted times.
        //
        // Events  :       |--A--|     |--B--|
        ...
        Collection<Event> events = Arrays.asList(
                ...
                new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
                        Arrays.asList(PERSON_B)),
                new Event("Event 3", TimeRange.fromStartDuration(TimeRange.WHOLE_DAY, DURATION_30_MINUTES),
    ...
    public void noMandatoryAttendeesGaps() {
        ...
        Collection<Event> events = Arrays.asList(
                ...
                new Event("Event 2", TimeRange.fromStartEnd(TIME_0930AM, TIME_1000AM, false),
                        Arrays.asList(PERSON_B)),
                new Event("Event 3", TimeRange.fromStartEnd(TIME_1030AM, TimeRange.END_OF_DAY, true),
                        Arrays.asList(PERSON_B)));
    ...
    public void testSeveralGaps() {
        ...
        Collection<Event> events = Arrays.asList(
                ...
                new Event("Event 2", TimeRange.fromStartEnd(TIME_1000AM, TIME_1100AM, false),
                        Arrays.asList(PERSON_A)),
                new Event("Event 5", TimeRange.fromStartEnd(TIME_1230PM, TIME_0130PM, false),
                        Arrays.asList(PERSON_B)),
                new Event("Event 3", TimeRange.fromStartEnd(TIME_0230PM, TIME_0330PM, false),
                        Arrays.asList(PERSON_A)),
                new Event("Event 4", TimeRange.fromStartEnd(TIME_0400PM, TIME_0430PM, false),
                        Arrays.asList(PERSON_B)));

        Collection<TimeRange> actual = query.query(events, request);
        Collection<TimeRange> expected =
                Arrays.asList(TimeRange.fromStartEnd(TIME_0900AM, TIME_0930AM, false),
                        TimeRange.fromStartEnd(TIME_1000AM, TIME_1130AM, false),
                        TimeRange.fromStartEnd(TIME_1130AM, TIME_1200PM, false),
                        TimeRange.fromStartEnd(TIME_1200PMM, TIME_1230PM, false),
                        TimeRange.fromStartEnd(TIME_0130PMM, TIME_0230PM, false),
                        TimeRange.fromStartEnd(TIME_0330PM, TIME_0400PM, false),
